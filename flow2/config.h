...
/* Define to 1 if you have the `SD2Lmain' library (-lSD2Lmain). */
/* #undef HAVE_LIBSD2LMAIN */
...
/* Name of package */
#define PACKAGE "flow2"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "jay-t@gmx.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "flow2"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "flow2 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "flow2"
